...
import AddNewItemModal from "../../../components/page/thuy-loi/cong/modalAddNew";
...
export default function Page() {
  ...
  const handleUpdate = async (editedItem: any) => {
    try {
      const response = await congServices.updateCong(editedItem.id, editedItem);
  ...
  return (
    <Fragment>
      ...
      >
        <Head>
          <title>{i18n.t("Quản lý công")}</title>
        </Head>
