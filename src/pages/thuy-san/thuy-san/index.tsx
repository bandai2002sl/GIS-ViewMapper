...
import AddNewItemModal from "../../../components/page/thuy-san/thuy-san/modalAddNew";
import BaseLayout from "~/components/layout/BaseLayout";
import CheckPermission from "~/components/common/CheckPermission";
import Head from "next/head";
import ModalEdit from "../../../components/page/ql-don-vi-hanh-chinh/don-vi-hanh-chinh/modalEdit";
import thuySanServices from "~/services/thuySanServices";
...
export default function Page() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const response = await thuySanServices.displayThuySan({
          name: "",
          moTa: "",
          image: "",
          tamNgung: "",
  ...
  const handleConfirmDelete = async (deleteItem: any) => {
    try {
      let res: any = await thuySanServices.deleteThuySan(deleteItem.id);
